...
for i_tree = 1: tNum
    ...
    [branch{i_tree}, branch_num{i_tree}] = ReadSkelFile([folder_name, '/', Files{i_tree}],[folder_name, '/', Files1{i_tree}]);
    ...
    for i=1: numel(trunk1.children)
        ...
        for j = 1: numel(trunk1.children{i}.children{ii}.children)
            for n_c=1:numel(trunk1.children{i}.children{ii}.children{j})
                new_children{k} = trunk1.children{i}.children{ii}.children{j}(n_c);
