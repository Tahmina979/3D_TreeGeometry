...
t = trimesh(T, X(:,1), X(:,2), X(:,3),...
    'FaceColor',[0.348, 0.214, 0.040],...
    'FaceAlpha',param.FaceAlpha,...
    'EdgeColor',[0.348, 0.214, 0.040],...
    'LineWidth', 0.05);
%hold off;
...
%hold on;
    ...
    %xlim([-1,9]);    % Set x-axis limits
    %ylim([-1,2]);    % Set y-axis limits
    %zlim([0,1.7]);    % Set z-axis limits
...
%}
set(t,'FaceColor',[0.348, 0.214, 0.040],'FaceLighting','phong','FaceVertexCData',f);
set(t,'SpecularStrength',0.2,'DiffuseStrength',0.2,'AmbientStrength',0.2);
%param.LightPos=param.LightPos*rotationMatrix_example(60,[0,1,0]);
