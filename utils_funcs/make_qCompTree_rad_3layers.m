function Q = make_qCompTree_rad_3layers(q0,srnf0,surf0,q_children,sk,b00, beta0_rad, beta_rad)
...
Q = orderfields(Q,{'t_paras','s','q0','srnf0','surf0','T0_pointNum','len0', 'K_sideNum','q','srnf','surf','T_sidePointNums','len', ...
