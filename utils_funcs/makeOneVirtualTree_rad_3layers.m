...
q_zero.srnf0=zeros(size(q_children.srnf0,1),size(q_children.srnf0,2),size(q_children.srnf0,3));
q_zero.surf0=zeros(size(q_children.surf0,1),size(q_children.surf0,2),size(q_children.surf0,3));
...
q_zero.srnf=q_children.srnf;
q_zero.surf=q_children.surf;
...
for i = 1: numel(q_zero.q)
    ...
    q_zero.srnf{i}= zeros(size(q_children.srnf{i},1),size(q_children.srnf{i},2),size(q_children.srnf{i},3));
    q_zero.surf{i}= zeros(size(q_children.surf{i},1),size(q_children.surf{i},2),size(q_children.surf{i},3));
