function Q = unflattenCompTree_4layers_rad(qsX,lam_m, lam_s, lam_p, refQ)
...
q_children_3Ls = repmat({struct('q0', [],'qsurf0',[],'surf0',[],'qnormx',[],'qnormy',[],'in_px',[],'in_py',[])}, 1, length(refQ.q_children));


Q = make_qtanCompTree_rad_4layers(q0, qsurf0,qsurf0(:,:,1:3), qnormx0,qnormy0,inpx0,inpy0,q_children_3Ls, sk, [0; 0 ;0], ...
...
for k=1: numel(Q.q_children)
    [Q.q_children{k},locator_qs0,locator_qs1] = unflattenCompTree_3layers_rad(qsX,lam_m, lam_s, lam_p, ...
